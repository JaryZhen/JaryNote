...
import com.github.fge.jsonschema.examples.Example2;
...
public final class Example5
{
        ...
        throws IOException, ProcessingException
    {
        ...
        final URITranslatorConfiguration translatorCfg = URITranslatorConfiguration.newBuilder().setNamespace(NAMESPACE).freeze();
