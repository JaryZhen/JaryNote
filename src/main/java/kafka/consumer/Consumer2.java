...
public class Consumer2 {
    ...
    public static  void pro() throws InterruptedException, ExecutionException {
       ...
       // props.put("advertised.port","9092");
        ...
        for (int messageNo = 1; messageNo < 500000 ; messageNo++  ){
            String messageStr = "Message_" + messageNo+" from jary";
           //Thread.sleep(500L);
            //System.out.print(messageNo+".........");
           Future<RecordMetadata> a =  producer.send(new ProducerRecord<String, String>("test",messageNo+"",messageNo+1+""));
    ...
    public static  void  con() {
        ...
        Properties props = new Properties();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG,"172.24.4.141:9092" );
